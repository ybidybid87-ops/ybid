              ...
              icon={
                canManageCompany ? (
                  <button
                    ...
                    className="flex h-16 w-16 items-center justify-center rounded-full bg-emerald-50 transition hover:bg-emerald-100"
                    aria-label="연락 일정 변경"
                  >
      ...
      <EditContactScheduleDialog
        ...
        contact={{
          ...
          companies: {
            ...
            contact_count: company.contact_histories.length,
          },
        }}
      />
    </>
